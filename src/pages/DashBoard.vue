          ...
          <Draggable :list="list.cards" group="cards" item-key="id">
            <template #item="{ element }">
              ...
              >
                ...
                <!-- Links Section -->
                <div
                  v-if="element.links?.length"
                  class="mt-2 space-y-1 text-blue-600 text-xs"
                  @click.stop
                >
                  <div
                    v-for="(link, idx) in element.links"
                    :key="'link-' + idx"
                    class="flex items-center gap-1"
                  >
                    <svg
                    ...
                    >
                      <path
                        ...
                        stroke-width="2"
                        d="M10 14l2-2m0 0l2-2m-2 2v6m-6-6h6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2v-6a2 2 0 012-2z"
                      />
                    </svg>
                    <a
